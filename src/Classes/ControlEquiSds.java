...
//----------------------------salvar objetos na tabela--------------------------------------------------
    public void Save() {
        ...
        try {
            ...
            stmt.executeUpdate("INSERT INTO controlequisds VALUES("
                    + this.getCodEquip()+ ","
                    + this.getPatrimonio()+ ",'"
                    + this.getEquipamento()+ "','"
                    + this.getModelo()+ "','"
    ...
    public ControlEquiSds(/*int CodEquip,*/ int Patrimonio, String Equipamento, String Modelo, String Departamento, String DataEnvio, String DataRetorno, String Selecione, float Orcamento, int CentroCusto) {
